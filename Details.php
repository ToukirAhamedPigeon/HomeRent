...
<html>
   ...
   <script src="./js/jssor.slider-24.1.5.min.js" type="text/javascript"></script>
	...
	<form id="form" action="DetailsPHP.php" method="post" enctype="multipart/form-data">
	<div class="container">
		<div class="reg-form">
			<div class="row title">
    ...
    <br>
			...
			<div class="row">
				...
				<div class="col-lg-3" id="book">
				<button type="button" id="unBook" class="form-control btn btn-danger"><b>Unbook</b></button>
				<button type="button" id="Book" class="form-control btn btn-success" ><b>Book Now</b></button></div>
				<div class="col-lg-2"></div>
			</div>
		</div>
		</div>
